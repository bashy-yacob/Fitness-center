...
// // קבוע של המפתח הסודי מהסביבה
// const JWT_SECRET = process.env.JWT_SECRET || 'your_jwt_secret';

// const verifyToken = (req, res, next) => {
//   // מומלץ לקבל טוקן בפורמט 'Bearer <token>'
...
//   try {
//     // פענוח הטוקן עם המפתח הנכון
//     const decoded = jwt.verify(token, JWT_SECRET);

//     // *** התיקון הקריטי: שמירת כל המידע המפוענח ב-req.user ***
//     req.user = decoded; // decoded יכיל { id, user_type, email }
...
//   // בדיקה לפי המידע שנשמר ב-req.user
...
//   if (req.user && (req.user.user_type === 'trainer' || req.user.user_type === 'admin')) { // אולי אדמין יכול לעשות פעולות של מאמן?
//     next();
//   } else {
...
// middleware/authMiddleware.js - הקוד המתוקן
