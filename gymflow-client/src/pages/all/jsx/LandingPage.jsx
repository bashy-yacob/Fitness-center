// בקובץ: src/pages/LandingPage.jsx
        ...
        <div className="landing-page">
            <section className="hero-section">
                <div className="hero-content">
                    ...
                    <div className="hero-buttons">
                        <Link to="/register" className="btn btn-primary btn-large">הצטרף עכשיו</Link>
                        <Link to="/login" className="btn btn-outline btn-large">התחבר</Link>
                    </div>
                </div>
            </section>
                ...
                {classesLoading ? (
                    ...
                    <div className="classes-grid">
                        {classes.map((classItem) => (
                            <div key={classItem.id} className="class-card card">
                                <div className="class-image" style={{ backgroundImage: `url(/images/${classItem.image || 'fitness-4998981_1280.jpg'})` }}>
                                    <div className="class-overlay">
                                        <h3 className='h3-card'>{classItem.name}</h3>
                                        <p>{classItem.description}</p>
                                        {/* === כאן הלוגיקה החדשה והמפושטת === */}
                                        <button
            ...
            <section className="faq-section section">
                ...
                <div className="faq-grid">
                    {faqs.map((faq, index) => (
                        <div key={index} className="faq-card" onClick={() => setOpenFaqIndex(openFaqIndex === index ? null : index)}>
